...
class PageModel extends Model
{
    ...
    public function getDefaultData(){
        ...
        $return = '<p>La plataforma de gestión y mantenimiento de esta web  hace parte de la franquicia BUSCOCOMERCIO . Los derechos y licencias de explotación de la marca, imagen y logotipo BUSCOCOMERCIO están vinculados y autorizados por la empresa <strong>DIGITAL COMPANY SHOPONLINE LLC.</strong>
...
con número de CIF B-64503238.</p><br>';
    ...
    public function getDefaultTerms(){
        ...
        $return = '<h3><strong>¿Quién es el Responsable del tratamiento de sus datos? </strong></h3>
                <p>DT TECNOLOGÍA 2007, S.L. (o BUSCOCOMERCIO) actúa como responsable del tratamiento de datos.</p>
                <table border="1">
                    <tbody>
                    <tr>
    ...
    public function getMyShopData(){
        ...
        $franchise = FranchiseModel::getFranchise();
        $franchiseContactData = $franchise->getFranchiseContactData();
        $return = '<p>La plataforma de gestión y mantenimiento de esta web  hace parte de la franquicia BUSCOCOMERCIO . Los derechos y licencias de explotación de la marca, imagen y logotipo ' . strtoupper($franchise->name) .' están vinculados a &nbsp;' . $franchiseContactData->name . '&nbsp;' . $franchiseContactData->surname . '
